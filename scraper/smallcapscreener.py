...
class SmallCapScreener:
    ...
    def init_screen(self, driver):
        ...
        print(critical_date.strftime("%m/%d/%Y"))
        screen = [
        ...
        input = '/html/body/div[2]/div[2]/div/div[4]/table/tbody/tr[3]/td/div/div[3]/div/div[2]/div/table/tbody/tr[1]/td/div/div[3]'
        form = '/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/input[1]'
        #/html/body/div[2]/div[2]/div/div[4]/table/tbody/tr[3]/td/div/div[3]/div/div[2]/div/table/tbody/tr[1]/td/div/div[3]
        #/html/body/div[2]/div[2]/div/div[4]/table/tbody/tr[3]/td/div/div[3]/div/div[2]/div/table/tbody/tr[1]/td/div/div[3]
        save_btn = '/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/div[3]'
        #/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/div[3]
        for condition in screen:
            self.click(input, Time.SMALL)
            self.send_keys(form, condition, Time.LONG)
            self.click(save_btn, Time.SMALL)

        add_condition = '/html/body/div[2]/div[2]/div/div[4]/table/tbody/tr[3]/td/div/div[3]/div/div[2]/div/table/tbody/tr[1]/td/div/div[1]/table/tbody/tr/td'
        self.click(add_condition, Time.SMALL)
        descriptive = '/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/table/tbody/tr[1]/td[1]'
        self.__hover(descriptive, Time.SMALL)
        filing_info = '/html/body/div[4]/div/table/tbody/tr[2]/td[2]/div/div/table/tbody/tr[4]/td[1]'
        self.__hover(filing_info, Time.SMALL)
        last_annual_filing = '/html/body/div[5]/div/table/tbody/tr[2]/td[2]/div/div/table/tbody/tr[2]/td'
        self.click(last_annual_filing, Time.SMALL)

        self.ghost.wait(Time.MEDIUM)
        dropdown = '/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/select'
        select = Select(self.driver.find_element_by_xpath(dropdown))
        select.select_by_value('>=')

        self.ghost.wait(Time.SMALL)
        date_input_xp = '/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/input'
        date_input = self.driver.find_element_by_xpath(date_input_xp)
        date_input.clear()
        self.send_keys(date_input_xp, critical_date.strftime("%m/%d/%Y"), Time.LONG)

        self.click('/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/div[1]', Time.VERY_SMALL)
        save_btn = '/html/body/div[3]/div/table/tbody/tr[2]/td[2]/div/div/div[4]'
        self.click(save_btn, Time.SMALL)
