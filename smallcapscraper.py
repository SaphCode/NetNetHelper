...
def process_data(working_directory):
    ...
    master.to_csv('{parent}/{filename}'.format(parent = working_directory, filename = 'smallcaps.csv'))
...
def main():
    ...
    if key == "y":
        ...
        screener = SmallCapScreener(driver, ghost)
    ...
    if key == "y":
        process_data('E:/Programming/Data/Stocks/SmallCap')
